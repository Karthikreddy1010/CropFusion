...
- **Pipeline Runtime**: 3613.0 seconds
- **Methodology validation**: `NON_COMPLIANT` (PASS=16, FAIL=2, WARNING=0, N/A=0) — see `methodology_validation_report.md`
...
| NeuralCQR_LightGBM_Ensemble | 0.9237 | 0.7091 | 0.7031 |     0.9194 | 3.3177 |          4.0751 |
...
- **O5 (Severity attribution)**: cluster-robust slope = `0.014295` (95% CI `[-0.005525, 0.034115]`, p = `0.11578`, clustered by year), R² = `0.027592` — effect magnitude: **weak**, statistically detectable: **False**.
- **O6 (Conformal method ranking)**: lowest average rank = `sa_aci` across 6 methods. Status: **descriptive ranking only**. Friedman executed: True, p = `0.52164` (blocked by year). Claims statistical superiority: **False**.
...
| sa_aci | 0.9194 | 3.3177 | 0.0194 | 4.0751 | yes |
