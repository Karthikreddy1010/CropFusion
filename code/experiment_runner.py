"""
experiment_runner.py - Exploratory Multi-Scenario Generalization & Tuning Suite (Legacy / Non-Authoritative).

NOTE: The authoritative temporal pipeline for Paper 3 is strictly implemented in `main.py`
using the 4-way temporal partition (FIT 1985-2013, DEV 2014-2015, CAL 2016-2018, TEST 2019-2023).
This file serves as a supplementary / exploratory benchmark suite and cannot overwrite final authoritative reports.
"""
...
def run_full_experiment_pipeline(
    ...
    tuned_temporal_model = train_neural_cqr(
        X_tr_base, y_tr_base_detrend, X_va_base, y_va_base_detrend, feature_cols,
        epochs=getattr(cfg, "OPTUNA_MAX_EPOCHS", 200), batch_size=frozen_batch_size, lr=frozen_lr, weight_decay=frozen_wd,
